...
echo "🚀 Photo Booth API Comprehensive Test Suite"
echo "=========================================="
echo ""

# Test 1: Direct Model Approach (Working)
echo "📋 Test 1: Direct DynamoDB Model Approach"
echo "----------------------------------------"
node test-direct-model.js
echo ""

# Test 2: Payment Methods Test
echo "📋 Test 2: Payment Methods Test"
echo "------------------------------"
node test-payment-methods.js
echo ""

# Test 3: Custom Function Approach (Currently failing)
echo "📋 Test 3: Custom Function Approach"
echo "----------------------------------"
node test-api.js
echo ""

# Test 4: Postman-style Test
echo "📋 Test 4: Postman-style Manual Test"
echo "-----------------------------------"
...
echo "}"
echo ""
echo "Variables (Album Order - Card Payment):"
echo "{"
echo "  \"input\": {"
...
echo "    \"totalPrice\": 5.0,"
echo "    \"currency\": \"USD\","
echo "    \"paymentMethod\": \"card_payment\","
echo "    \"imageCount\": 1,"
...
echo "}"
echo ""
echo "Variables (Collage Order - Bank Transfer):"
echo "{"
echo "  \"input\": {"
...
echo ""
echo "📊 Summary:"
echo "  - Direct Model API: ✅ Working"
echo "  - Custom Function API: ❌ Needs deployment fix"
echo "  - Manual Testing: ✅ Ready for Postman"
